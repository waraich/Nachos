...
public final class ElevatorBank implements Runnable {
    ...
    /**
     * Add a rider to the simulation. This method must not be called after <tt>run()</tt> is called.
     * 
     * @param rider the rider to add.
     * @param floor the floor the rider will start on.
     * @param stops the array to pass to the rider's <tt>initialize()</tt> method.
