...
public class Coff {
     ...
     * Notes:
     * <ol>
     * <li>If the constructor returns successfully, the file becomes the property of this loader, and should not be
     * accessed any further.
     * <li>The autograder expects this loader class to be used. Do not load sections through any other mechanism.
     * <li>This loader will verify that the file is backed by a file system, by asserting that read() operations take
     * non-zero simulated time to complete. Do not supply a file backed by a simulated cache (the primary purpose of
     * this restriction is to prevent sections from being loaded instantaneously while handling page faults).
     * </ol>
     * 
