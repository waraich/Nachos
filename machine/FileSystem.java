...
public interface FileSystem {
     ...
     * already exist and <tt>create</tt> is <tt>false</tt>, returns <tt>null</tt>. If the file does not already exist
     * and <tt>create</tt> is <tt>true</tt>, creates the file with zero length. If the file already
