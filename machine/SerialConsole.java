...
public interface SerialConsole {
     ...
     * 
     * <p>
     * The receive interrupt handler is called every time another byte arrives and can be read using <tt>readByte()</tt>.
     * 
     * <p>
     * The send interrupt handler is called every time a byte sent with <tt>writeByte()</tt> is finished being sent.
     * This means that another byte can be sent.
     * 
    ...
    /**
     * Return the next unsigned byte received (in the range <tt>0</tt> through <tt>255</tt>).
     * 
