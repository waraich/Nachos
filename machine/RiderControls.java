...
public interface RiderControls {
    ...
    /**
     * Return the indicated direction of the specified elevator, set by <tt>ElevatorControls.setDirectionDisplay()</tt>.
     * 
    ...
    /**
     * Press a direction button. If <tt>up</tt> is <tt>true</tt>, invoke <tt>pressUpButton()</tt>; otherwise, invoke
     * <tt>pressDownButton()</tt>.
     * 
     * @param up <tt>true</tt> to press the up button, <tt>false</tt> to
     *            press the down button.
     * @return the return value of <tt>pressUpButton()</tt> or of <tt>pressDownButton()</tt>.
     */
