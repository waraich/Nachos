...
public class Rider implements RiderInterface {
     ...
     * 
     * <p>
     * For example, suppose the rider uses <i>controls</i> to determine that it is initially on floor 1, and suppose the
     * stops array contains two elements: { 0, 2 }. Then the rider should get on an elevator, get off on floor 0, get on
     * an elevator, and get off on floor 2, pushing buttons as necessary.
     * 
     * <p>
     * This method should not return, but instead should call <tt>controls.finish()</tt> when the rider is finished.
     */
    public void run() {
    }
}
