...
/**
 * The default autograder. Loads the kernel, and then tests it using <tt>Kernel.selfTest()</tt>.
 */
public class AutoGrader {
    ...
    /**
     * Start this autograder. Extract the <tt>-#</tt> arguments, call <tt>init()</tt>, load and initialize the kernel,
     * and call <tt>run()</tt>.
     * 
    ...
    /**
     * Notify the autograder that the specified thread is the idle thread. <tt>KThread.createIdleThread()</tt>
     * <i>must</i> call this method before
    ...
    /**
     * Notify the autograder that the specified thread is now running. <tt>KThread.restoreState()</tt> <i>must</i> call
     * this method before
     * returning.
     * 
    ...
    /**
     * Notify the autograder that the current thread has finished. <tt>KThread.finish()</tt> <i>must</i> call this
     * method before putting
