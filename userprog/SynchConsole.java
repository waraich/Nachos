...
public class SynchConsole {
    ...
    /**
     * Return the next unsigned byte received (in the range <tt>0</tt> through <tt>255</tt>). If a byte has not arrived
     * at, blocks until a byte
     ...
     * @return the next byte read, or -1 if <tt>block</tt> was <tt>false</tt> and no byte was available.
     */
