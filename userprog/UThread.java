...
public class UThread extends KThread {
     ...
     * 
     * <p>
     * A thread capable of running user code actually has <i>two</i> sets of CPU registers: one for its state while
     * executing user code, and one for its state while executing kernel code. While this thread is not running, its
