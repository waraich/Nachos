 ...
 * 
 * <p>
 * The Nachos kernel should <i>never</i> be able to directly perform any of these privileged operations. If you have
 * discovered a loophole somewhere, notify someone.
 */
public abstract class Privilege {
    ...
    /**
     * Invoke each <tt>exit()</tt> notification handler added by <tt>addExitNotificationHandler()</tt>. Called by
     * <tt>exit()</tt>.
     */
    ...
    /**
     * An interface that provides access to some private <tt>Machine</tt> methods.
     */
    ...
    /**
     * An interface that provides access to some private <tt>Interrupt</tt> methods.
     */
    ...
    /**
     * An interface that provides access to some private <tt>Processor</tt> methods.
     */
    ...
    public interface TCBPrivilege {
        /**
         * Associate the current TCB with the specified <tt>KThread</tt>. <tt>AutoGrader.runningThread()</tt>
         * <i>must</i> call this method
         * before returning.
         * 
